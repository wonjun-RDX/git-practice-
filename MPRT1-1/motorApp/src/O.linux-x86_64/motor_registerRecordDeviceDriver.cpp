...
/* Generated from ../O.Common/motor.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_asynAoInt64, *pvar_dset_devAoStats,
...
static const char * const deviceSupportNames[] = {
    ...
    "asynAiFloat64Average", "asynAiInt64", "devAiStats", "devAiClusts",
...
epicsShareExtern reg_func pvar_func_arrInitialize,
    ...
    pvar_func_utagInitialize, pvar_func_register_func_rebootProc,
...
int motor_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/usr/local/epics/EPICS7/RADEXEL-DEV/EPICS-DEV/MPRT1-1";
...
/* motor_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: motor_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(motor_registerRecordDeviceDriver(*iocshPpdbbase));
}
